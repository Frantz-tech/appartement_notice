    ...
    <div className='flex w-full bg-neutral-400 p-2 px-6 h-24 justify-between items-center border-b-2 '>
      ...
      px-1.5 bg-blue-200 -mt-2.5'>
        ...
        <div className='textUnderLogo'>
          <p
            className='text-gray-700 text-xs text-shadow-xs
          '>
    ...
    return (
      <>
        <div className='flex flex-col items-end'>
          <span
            className='text-black text-sm capitalize font-bold
          '>
            {formattedDate}
          </span>
          <span className='text-gray-700 text-sm'>{formattedHour}</span>
        </div>
      </>
    )
  }
